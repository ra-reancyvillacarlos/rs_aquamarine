...
{
    public partial class m_technician : Form
    {
        ...
        private void m_technician_Load(object sender, EventArgs e)
        {
        ...
        private void disp_list()
        {
            ...
            DataTable dt = db.QueryAllOnTable("technician");
            ...
            try
            {
                for (int r = 0; dt.Rows.Count > r; r++)
                {
                    ...
                    row.Cells["id"].Value = dt.Rows[r]["tech_code"].ToString();
                    row.Cells["name"].Value = dt.Rows[r]["tech_name"].ToString();
                }
            }
            catch (Exception) { }
        }
        ...
        private void btn_delitem_Click(object sender, EventArgs e)
        {
            ...
            if (dgv_list.Rows.Count > 1)
            {
                ...
                if (db.UpdateOnTable("technician", "cancel='Y'", "tech_code='" + dgv_list["ID", r].Value.ToString() + "'"))
                {
                    disp_list();
                    goto_tbcntrl_list();
                    tpg_info_enable(false);
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (isnew)
                {
                    ...
                    col = "tech_code, tech_name";
                    val = "'" + code + "', '" + desc + "'";

                    if (db.InsertOnTable("technician", col, val))
                    {
                        success = true;
                    ...
                    {
                        success = false;
                        db.DeleteOnTable("technician", "tech_code='" + code + "'");
                        MessageBox.Show("Failed on saving.");
                    }
                }
                else
                {
                    col = "tech_code='" + code + "', tech_name='" + desc + "'";

                    if (db.UpdateOnTable("technician", col, "tech_code='" + code + "'"))
                    {
                        success = true;
                    }
                    else
