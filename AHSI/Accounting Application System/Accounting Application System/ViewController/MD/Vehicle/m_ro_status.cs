...
{
    public partial class m_ro_status : Form
    {
        ...
        private void m_ro_status_Load(object sender, EventArgs e)
        {
        ...
        private void disp_list()
        {
            ...
            DataTable dt = db.get_ro_status_list();
            ...
            try
            {
                for (int r = 0; dt.Rows.Count > r; r++)
                {
                    ...
                    row.Cells["id"].Value = dt.Rows[r]["ro_stat_code"].ToString();
                    row.Cells["name"].Value = dt.Rows[r]["ro_stat_desc"].ToString();
                }
            }
            catch (Exception) { }
        }
        ...
        private void btn_delitem_Click(object sender, EventArgs e)
        {
            ...
            if (dgv_list.Rows.Count > 1)
            {
                ...
                if (db.UpdateOnTable("ro_status", "cancel='Y'", "ro_stat_code='" + dgv_list["ID", r].Value.ToString() + "'"))
                {
                    disp_list();
                    goto_tbcntrl_list();
                    tpg_info_enable(false);
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (isnew)
                {
                    ...
                    col = "ro_stat_code, ro_stat_desc";
                    val = "'" + code + "', '" + desc + "'";

                    if (db.InsertOnTable("ro_status", col, val))
                    {
                        success = true;
                    ...
                    {
                        success = false;
                        db.DeleteOnTable("ro_status", "ro_stat_code='" + code + "'");
                        MessageBox.Show("Failed on saving.");
                    }
                }
                else
                {
                    col = "ro_stat_code='" + code + "', ro_stat_desc='" + desc + "'";

                    if (db.UpdateOnTable("ro_status", col, "ro_stat_code='" + code + "'"))
                    {
                        success = true;
                    }
                    else
