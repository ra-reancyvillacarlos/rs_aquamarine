...
{
    public partial class a_CollectionEntry2 : Form
    {
        ...
        private void btn_mainsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {  //db.get_jtypename(j_code)
                    ...
                    val = "'" + fy + "', '" + j_code + "', '" + j_num + "', '" + trnx_date + "', '" + t_desc + "', '" + user_id + "', '" + t_date + "', '" + t_time + "', '" + mydate.ToString("MM") + "','" + collector + "'";
                ...
                {
                    col = "fy='" + fy + "', j_code='" + j_code + "', j_num='" + j_num + "', t_date='" + trnx_date + "', t_desc='" + t_desc + "', user_id='" + user_id + "', sysdate='" + t_date + "', systime='" + t_time + "', mo='" + mydate.ToString("MM") + "', collectorid='" + collector + "'";
