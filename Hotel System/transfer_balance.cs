...
{
    public partial class transfer_balance : Form
    {
        ...
        public transfer_balance(newGuestBilling frm, String gfolio, String gname, String rm, String dchg_amt, String dwhole_balance)
        {
        ...
        private void transfer_balance_Load(object sender, EventArgs e)
        {
            disp_currently_guest("");
            cbo_option.SelectedIndex = 2;
        }
        ...
        private void btn_transfer_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String trans_chg = db.get_pk("chg_trb");
                String refer_frm = "CHG TO " + lbl_rm_to.Text + "-" + lbl_guest_to.Text;
                String refer_to = "CHG FR " + lbl_rm_frm.Text + "-" + lbl_guest_frm.Text;
                ...
                if (db.InsertOnTable("chgfil", "reg_num, chg_code, chg_num, rom_code, reference, amount, user_id, t_date, t_time, chg_date, tofr_fol", val_frm))
                {
                    ...
                    MessageBox.Show("Successfully transfer balance.");
                    isUpdated = true;
                    this.Close();
                }
                else
                {
                    MessageBox.Show("Error on tranfering balance.");
                }
                //}
                //else
                //{
        ...
        private void cbo_option_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                txt_bal_amt.Text = chg_amt;
                cbo_type.SelectedIndex = 0;
            }
            else if (cbo_option.SelectedIndex == 2)
            {
                txt_bal_amt.ReadOnly = false;
                txt_bal_amt.Text = "0.00";
                cbo_type.SelectedIndex = 0;
            }
            else if (cbo_option.SelectedIndex == 4)
            {
                txt_bal_amt.Text = "0.00";
